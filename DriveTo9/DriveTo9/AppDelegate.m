...
@synthesize navController,manager;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	//Initializing Singlton Object of ViewManager Class.
	self.manager = [ViewManager sharedManager];
	[self.manager registerViewsToManager];
